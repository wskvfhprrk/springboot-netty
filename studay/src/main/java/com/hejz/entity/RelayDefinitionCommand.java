...
public class RelayDefinitionCommand implements Serializable {
    ...
    public RelayDefinitionCommand(String imei, String name, String remarks, String relayIds, boolean isProcessTheReturnValue, long processingWaitingTime, Long commonId) {
        this.imei=imei;
        this.name=name;
