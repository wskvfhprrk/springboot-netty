 ...
 */
@Data
public class RelayDefinitionCommandUpdateDto {
    ...
    @NotEmpty
    private Long dtuId;
    @ApiModelProperty(value = "指令类型枚举",required = true,example = "1")
    @NotEmpty
    private Integer instructionTypeEnum;
    @ApiModelProperty(value = "是否处理返回值——false表示不用，true表示必须处理",required = true,example = "1")
    @NotEmpty
