...
public class MenuCreateDto {
    ...
    @NotEmpty
    private String name;
    @ApiModelProperty(value = "排序编号",required = true,example = "22")
    @NotEmpty
    private Integer orderByNo;
    @ApiModelProperty(value = "父级Id",required = true,example = "22")
    @NotEmpty
    ...
    @ApiModelProperty(value = "类型——1父级菜单、2子菜单、3按纽",required = true,example = "22")
    @NotEmpty
